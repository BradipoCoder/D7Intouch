        ...
        <th class="flexible">
            ...
            <table width="560" align="center" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <th>
            <![endif]-->
            <table width="600" bgcolor="#e1e1e1" class="content" align="center" cellpadding="20" cellspacing="0" border="0" style="border-collapse:separate;table-layout:fixed;width:100%;max-width:600px;">
                <!--header new-->
                <tr>
                ...
                <?php foreach($content["articles"] as $article): ?>
                    <tr>
                        <th colspan="3" align="center" class="flexible" valign="top"><?php print render($article); ?></th>
                    </tr>
                <?php endforeach; ?>
                <!--NLARTICLES - END-->
