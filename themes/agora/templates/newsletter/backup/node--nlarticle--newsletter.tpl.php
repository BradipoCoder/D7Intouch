            ...
            <table align="center" cellpadding="0" cellspacing="0">
                        ...
                        <table cellspacing="10" cellpadding="0" border="0">
                            <tr>
                                ...
                                <th width="500" align="left">
                                    <a style="text-decoration:none;display:block" href="<?php print $content["link2article"]; ?>" target="_blank">
                                        <span class="outlook-fontfix" style="font-family: Roboto, arial,sans-serif; font-size: 32px; color: #222; font-weight:300;line-height: 32px;">
                ...
                <tr>
                    <th colspan="3" align="center">
                        ...
                        <a href="<?php print $content["link2article"]; ?>" target="_blank" style="display:block">                        
                    ...
                    <th align="left">
                        <table cellspacing="10" cellpadding="0" border="0">
                            <tr>
                                ...
                                <th width="500" align="left">
                                <span class="outlook-fontfix" style="font-family: Roboto, arial,sans-serif; color:#222;font-size:14px; font-weight:400; line-height:24px;">
